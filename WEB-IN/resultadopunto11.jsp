...
<body>
    ...
    <div class="jumbotron jumbotron-fluid bg-dark text-white">
        <div class="container p-3 my-3 bd-dark">
            <h1 class="text-center font-effect-3d-float"><b>Ejercicio 11</b></h1>
            <h2 class="text-center font-effect-3d-float" style="padding:50px;">Color favorito uso de componente Check box: </h2>
        </div>
    </div>
    <%
    ...
    %>
    <li class="text-center mx-2 "><p class="h2"><%=color[i]%></p></li>
    <%
        }
    %>
    </ul>
    ...
    <%
            ...
            String res ="ERROR NO ESCOGISTE UN COLOR";
    %>
    ...
    <div class="text-center mt-4 mb-3">
        <a href="../html/punto11.html" class="btn btn-dark">Volver al menu de coloresx</a>
    </div>
    <%
        }   
    %>
