...
<body>
    ...
    <div class="jumbotron jumbotron-fluid bg-dark text-white">
        <div class="container p-3 my-3 bd-dark">
            <h1 class="text-center font-effect-3d-float"><b>Ejercicio 8</b></h1>
            <h2 class="text-center font-effect-3d-float" style="padding:50px;">Algoritmo que calcule y muestre el sueldo neto de un trabajador. </h2>
        </div>
    </div>
    <div class="container mt-5" style="font-family: 'Lora', serif;">
        <form class="mx-auto"
            ...
            action="../WEB-IN/punto8.jsp">
            <div class="mb-3">
                <label for="base" class="form-label" style="font-weight: 700;">Ingrese la cantidad de empleados<br><br>
                </label>
