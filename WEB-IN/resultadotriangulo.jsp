...
<div class="jumbotron jumbotron-fluid bg-dark text-white">
        <div class="container p-3 my-3 bd-dark">
            <h1 class="text-center font-effect-3d-float"><b></b></h1>
            <h2 class="text-center font-effect-3d-float" style="padding:50px;">Resultado:</h2>
        </div>
    </div>
    <%
        ...
        String hola =("EL AREA DEL TRIANGULO DE BASE " + base + " Y ALTURA " + altura + " ES DE: "+ area);
    
    %>
    <div class="jumbotron jumbotron-fluid bg-mute text-white">
        <p class="h2 text-center font-effect-3d-float text-dark"> <%=hola %></p>
    </div>
    <div class="container text-center mt-4 mb-3">
        <a href="../index.html" class="btn btn-dark">Volver al menu principal</a><br><a href="../html/punto4.html" class="btn btn-dark mt-4">Calcular el area de otro triangulo</a>
    </div>
