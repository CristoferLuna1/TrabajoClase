...
<div class="jumbotron jumbotron-fluid bg-dark text-white">
        <div class="container p-3 my-3 bd-dark">
            <h1 class="text-center font-effect-3d-float"><b>Ejercicio 9</b></h1>
            <h2 class="text-center font-effect-3d-float" style="padding:50px;">Aqui podras hallar el area de una piramide de base triangular:</h2>  
        </div>
</div>
<%
    int altura,lado;
    ...
    /*   */
    double volumen=((lado*lado)*(MiRaiz)*(altura/4))/3;
    /* out.println(volumen);
    out.println(altura); */
%>
    <div class="jumbotron jumbotron-fluid bg-mute text-white">
        <p class="h2 text-center font-effect-3d-float text-dark">El Area de la piramide es: <%=volumen %> m^3</p>
    </div>
