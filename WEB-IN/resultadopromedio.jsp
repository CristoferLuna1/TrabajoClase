...
<div class="jumbotron jumbotron-fluid bg-dark text-white">
    ...
    <form class="mx-auto" action="../WEB-IN/promedio.jsp"
            ...
            <div class="mb-3">
            <label for="base" class="form-label" style="font-weight: 700;">Ingrese las notas del estudiante:</label><br>
    ...
    %>
                <label for="base" class="form-label" style="font-weight: 700;">Nota <%=i+1 %>: </label>
                <input type="text" class="form-control" id="base" name="nota<%=i%>" required pattern="\d+(\.\d{1,2})?"
                    title="Por facor, ingrese un numero valido"
                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
   
    <%
        }}else{
            String mensaje = "La cantidad de notas no puede ser 0 ni 1";
    ...
    %>
            <div class="text-center mb-3 my-4">
                ...
                <a href="../prueba.html" class="btn btn-dark">Volver al menu principal</a><br><a href="../WEB-IN/punto5.jsp" class="btn btn-dark mt-4">Volver a escoger cantidad de Notas</a>
            </div>
    <%
        }else{
    ...
    <div class="alert alert-danger">
            <strong>ERROR la cantidad de notas digitada no es valida</strong>
            </div>
        </div>
